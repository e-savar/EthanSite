...
*/}
                    <a className=" inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-gray-300 text-primary-foreground  h-11 rounded-md px-8 w-full sm:w-auto min-w-[140px] ">View Projects</a>
                    ...
                    <a className=" inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-gray-300 text-primary-foreground  h-11 rounded-md px-8 w-full sm:w-auto min-w-[140px] ">Contact</a>
                ...
                <div className="rounded-lg border text-card-foreground shadow-sm hover:shadow-lg transition-shadow bg-white dark:bg-black border-gray-200 dark:border-gray-800">
                    <div className="p-4 md:p-6">
                        <div className="flex mb-4">
                            <div className="w-12 h-12 bg-gray-100 dark:bg-gray-900 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80 ml-4 flex-shrink-0">
                                    3.5 GPA
                                    </div>
                                </div>
                            ...
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Computer Science</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Theoretical Mathematics</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Honors</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Engineering</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Business</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Research</Badge>
                            <Badge className="px-2.5 py-0.5 bg-darkgray text-black border-gray">Quantitative Finance</Badge>
                        </div>
                    </div>
                </div>
            </div>       
